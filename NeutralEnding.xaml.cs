...
namespace Visual_Novel_Final_Project
{
    ...
    /// </summary>
    public partial class NeutralEnding : Page
    {

        public NeutralEnding()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                tblkDefaultText.Text = EndingPlayer.pName + "  decided that adventuring is tough and being a hero is too much work, so he decided to give it up for more peaceful direction.\nEncountering the merchant he’d met previously, " + EndingPlayer.pName + " asked to work alongside the merchant who was skeptical at first.\nEventually " + EndingPlayer.pName + " learned the trade and went off to expand his own business.";
            }

            if (EndingPlayer.pGender == "Female")
            {
                tblkDefaultText.Text = EndingPlayer.pName + "  decided that adventuring is tough and being a hero is too much work, so she decided to give it up for more peaceful direction.\nEncountering the merchant she’d met previously, " + EndingPlayer.pName + " asked to work alongside the merchant who was skeptical at first.\nEventually " + EndingPlayer.pName + " learned the trade and went off to expand her own business.";
            }
