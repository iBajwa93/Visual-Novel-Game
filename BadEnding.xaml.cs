...
namespace Visual_Novel_Final_Project
{
    ...
    /// </summary>
    public partial class BadEnding : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                tblkDefaultText.Text = EndingPlayer.pName + " decided to take the Dragon’s scepter into his own hands and lock away the princess whose ability was the only thing that could stop him from what he did next.\nUsing his newfound power " + EndingPlayer.pName + " overthrew the king and became the new ruler, building a dark army to take over the world.";
            }

            if (EndingPlayer.pGender == "Female")
            {
                tblkDefaultText.Text = EndingPlayer.pName + " decided to take the Dragon’s scepter into her own hands and lock away the princess whose ability was the only thing that could stop her from what she did next.\nUsing her newfound power " + EndingPlayer.pName + " overthrew the king and became the new ruler, building a dark army to take over the world.";
            }
